    ...
    const translations = {
        en: {
            ...
            servers: {
                ...
                sortName: 'Name',
                refresh: 'Refresh',
                updatedSecondsAgo: 'Updated a few seconds ago',
                ...
                noFavorites: 'No favorites yet - star servers to pin them here.',
                join: 'Join',
                joinComingSoon: 'Joining servers from the launcher is coming soon.',
                joiningToast: 'Joining {{name}}...',
                joinInstallFirst: 'Install the game first, then join from here.',
                passworded: 'Password protected',
                bots: '{{count}} bots',
                favoriteAdd: 'Add to favorites',
                favoriteRemove: 'Remove from favorites',
                count: '{{shown}} of {{total}} servers',
                empty: 'No servers found for this game right now.',
                noMatches: 'No servers match your filters.',
        ...
        fr: {
            ...
            servers: {
                ...
                hideFull: 'Masquer pleins',
                sortPlayers: 'Plus de joueurs',
                sortPing: 'Meilleur ping',
                sortName: 'Nom',
                refresh: 'Actualiser',
                updatedSecondsAgo: 'Actualise il y a quelques secondes',
                updatedMinutesAgo: 'Actualise il y a {{minutes}} min',
                updatedHoursAgo: 'Actualise il y a {{hours}} h',
                colName: 'Serveur',
                colMap: 'Carte',
                colMode: 'Mode',
                colRegion: 'Region',
                ...
                countPlayers: '{{count}} joueurs',
                noFavorites: 'Aucun favori pour le moment - etoilez des serveurs pour les epingler ici.',
                join: 'Rejoindre',
                joinComingSoon: 'Rejoindre des serveurs depuis le launcher arrive bientot.',
                joiningToast: 'Connexion a {{name}}...',
                joinInstallFirst: "Installez d'abord le jeu, puis rejoignez depuis ici.",
                passworded: 'Protege par mot de passe',
                bots: '{{count}} bots',
                favoriteAdd: 'Ajouter aux favoris',
                favoriteRemove: 'Retirer des favoris',
                count: '{{shown}} serveurs sur {{total}}',
                empty: 'Aucun serveur trouve pour ce jeu pour le moment.',
                noMatches: 'Aucun serveur ne correspond a vos filtres.',
        ...
        es: {
            ...
            servers: {
                ...
                filterAll: 'Todos',
                favorites: 'Favoritos',
                hideEmpty: 'Ocultar vacios',
                hideFull: 'Ocultar llenos',
                sortPlayers: 'Mas jugadores',
                sortPing: 'Mejor ping',
                sortName: 'Nombre',
                refresh: 'Actualizar',
                updatedSecondsAgo: 'Actualizado hace unos segundos',
                ...
                noFavorites: 'Aun no hay favoritos - marca servidores con la estrella para fijarlos aqui.',
                join: 'Unirse',
                joinComingSoon: 'Unirse a servidores desde el launcher llegara pronto.',
                joiningToast: 'Uniendose a {{name}}...',
                joinInstallFirst: 'Instala primero el juego y luego unete desde aqui.',
                passworded: 'Protegido con contrasena',
                bots: '{{count}} bots',
                favoriteAdd: 'Anadir a favoritos',
                favoriteRemove: 'Quitar de favoritos',
                count: '{{shown}} de {{total}} servidores',
                empty: 'No se encontraron servidores para este juego ahora mismo.',
                noMatches: 'Ningun servidor coincide con tus filtros.',
        ...
        ru: {
            ...
            servers: {
                ...
                sortPing: 'Лучший пинг',
                sortName: 'Название',
                refresh: 'Обновить',
                updatedSecondsAgo: 'Обновлено несколько секунд назад',
                updatedMinutesAgo: 'Обновлено {{minutes}} мин назад',
                ...
                countPlayers: 'Игроков: {{count}}',
                noFavorites: 'Пока нет избранных — отметьте серверы звездой, чтобы закрепить их здесь.',
                join: 'Войти',
                joinComingSoon: 'Подключение к серверам из лаунчера появится скоро.',
                joiningToast: 'Подключение к {{name}}...',
                joinInstallFirst: 'Сначала установите игру, затем подключайтесь отсюда.',
                passworded: 'Защищен паролем',
                bots: 'Ботов: {{count}}',
                favoriteAdd: 'Добавить в избранное',
                favoriteRemove: 'Убрать из избранного',
                count: '{{shown}} из {{total}} серверов',
                empty: 'Серверы для этой игры сейчас не найдены.',
                noMatches: 'Нет серверов, соответствующих фильтрам.',
