    ...
    const translations = {
        en: {
            cb: {
                ...
                createSub: 'Your launcher identity: friends without Discord, a profile you can customise and playtime tracked for each game.',
                handle: 'Handle',
                ...
                handleCopied: 'Copied @{{handle}} to the clipboard.',
                ...
                recoveryWarning: "Never share this code or show it on stream. Anyone who has it can sign in to your CB profile from their own PC.",
                showCode: 'Show',
                hideCode: 'Hide',
                copy: 'Copy',
                copied: 'Copied',
            ...
            friends: {
                ...
                openMatch: 'Private',
                more: 'More',
                emptyCb: 'No friends yet. Add someone by their handle.',
                setupTitle: 'Play with friends',
                setupBody: 'Create a CB profile to add and message friends by handle, customise your profile and track your playtime in each game. Or link Discord to see your Discord friends who use the launcher.',
                setupCbBody: 'Create a CB profile to add and message friends by handle, customise your profile, track your playtime in each game and play with people who are not on Discord.',
                createCb: 'Create CB profile',
                linkDiscord: 'Link Discord',
                unlinkDiscord: 'Unlink Discord',
                discordLinked: 'Discord linked',
                discordFriend: 'Discord friend',
            ...
            toasts: {
                ...
                friendOffline: 'That friend is not in the launcher right now',
            ...
            common: {
                ok: 'OK',
                cancel: 'Cancel',
                inServers: 'in servers',
                inLauncher: 'in launcher',
                inServersHint: 'Players in public servers right now',
                inLauncherHint: 'People running this game from the CB launcher right now',
                confirm: 'Confirm',
                save: 'Save',
                play: 'Play',
                verify: 'Verify Files',
            ...
            settings: {
                ...
                skipSelfUpdate: 'Skip launcher update on startup',
                skipSelfUpdateBody: 'When enabled, the launcher will not update itself on startup. Same as the -noupdate flag. Takes effect the next time the launcher starts.',
                restartOffline: 'Restart in offline mode',
                restartOnline: 'Restart online',
                portableMode: 'Portable mode',
                portableModeBody: 'Keeps launcher data and settings in a cbservers folder next to the launcher exe instead of AppData. Same as the -portable flag. Switching moves your data to the new location and restarts the launcher.',
                ...
                portableConfirmBody: 'Your settings, clients and mod receipts will be moved to the new location and the launcher will restart. Caches are rebuilt on first use. Continue?',
                portableFailed: 'Could not move launcher data. Nothing was changed.',
                offlineMode: 'Offline mode',
                offlineModeBody: 'When enabled, the launcher starts without updates, Discord or CB Friends. Same as the -offline flag. Takes effect the next time the launcher starts.',
                autoShortcuts: 'Create launcher shortcuts',
                autoShortcutsBody: 'Keeps a Desktop and Start Menu shortcut for the launcher. Turning this off also stops Windows notifications, since they are delivered through the Start Menu shortcut.',
                ...
                cliLaunch: "Launch a game on startup (cod4, waw, mw2, bo1, mw3, bo2, cod2, or any library id)",
                cliMode: "Mode to use together with -launch",
                cliInstall: "Open the setup flow for a game on startup",
                cliNoUpdate: "Skip the launcher self-update check",
                cliOffline: "Start without network features (no updates, Discord or social)",
                ...
                theme: 'Theme',
                themeTactical: 'Tactical Black Ops',
                themeTacticalMw: 'Tactical Modern Warfare',
                themeNavy: 'Navy Dark',
                themeDark: 'Dark',
                themeNavyGradient: 'Navy Gradient',
                playerCounts: 'Player counts',
                playerCountsBody: 'Which live player count the library and game pages show. Players in servers and players in the launcher are counted separately and cannot be added together.',
                playerCountsBoth: 'Both',
                playerCountsServers: 'In servers',
                playerCountsLauncher: 'In launcher',
                playerCountsOff: 'Hidden',
            ...
            servers: {
                ...
                join: 'Join',
                copyConnect: 'Copy',
                copyConnectTitle: 'Copy the connect command, then paste it into the in-game console',
                connectCopied: 'Copied "{{command}}". Paste it into the in-game console.',
                copyFailed: 'Could not copy to the clipboard.',
            ...
            game: {
                ...
                'h1-mod': {
                    ...
                    descriptionWarning: "If you have an NVIDIA RTX graphics card, keep the in-game Pre-Cache Shaders setting off. Enabling it is known to crash the game on RTX GPUs.",
                ...
                'hmw-mod': {
                    description: "HorizonMW is a community remaster of Modern Warfare 2 multiplayer, carrying maps, weapons and systems from both MWR and MW3 along with a few guns from Ghosts.",
                    descriptionWarning: "If you have an NVIDIA RTX graphics card, keep the in-game Pre-Cache Shaders setting off. Enabling it is known to crash the game on RTX GPUs.",
        ...
        fr: {
            ...
            friends: {
                ...
                openMatch: 'Privée',
                more: 'Plus',
                emptyCb: "Aucun ami pour le moment. Ajoutez quelqu'un par son pseudo.",
                setupTitle: 'Jouer avec vos amis',
                setupBody: 'Creez un profil CB pour ajouter des amis par pseudo et leur envoyer des messages, personnaliser votre profil et suivre votre temps de jeu sur chaque jeu. Ou liez Discord pour voir vos amis Discord qui utilisent le launcher.',
                setupCbBody: 'Creez un profil CB pour ajouter des amis par pseudo et leur envoyer des messages, personnaliser votre profil, suivre votre temps de jeu sur chaque jeu et jouer avec ceux qui ne sont pas sur Discord.',
                createCb: 'Creer un profil CB',
                linkDiscord: 'Lier Discord',
                unlinkDiscord: 'Delier Discord',
                discordLinked: 'Discord lie',
                discordFriend: 'Ami Discord',
            ...
            toasts: {
                ...
                friendOffline: 'Cet ami est hors du launcher en ce moment',
            ...
            common: {
                ok: 'OK',
                cancel: 'Annuler',
                inServers: 'sur les serveurs',
                inLauncher: 'dans le launcher',
                inServersHint: 'Joueurs sur les serveurs publics en ce moment',
                inLauncherHint: 'Personnes lancant ce jeu depuis le launcher CB en ce moment',
                confirm: 'Confirmer',
                save: 'Enregistrer',
                play: 'Jouer',
            ...
            settings: {
                ...
                skipSelfUpdate: 'Ignorer la mise a jour du launcher au demarrage',
                skipSelfUpdateBody: "Lorsqu'active, le launcher ne se mettra pas a jour au demarrage. Equivalent de l'option -noupdate. Prend effet au prochain demarrage du launcher.",
                restartOffline: 'Redemarrer hors ligne',
                restartOnline: 'Redemarrer en ligne',
                portableMode: 'Mode portable',
                portableModeBody: "Conserve les donnees et parametres du launcher dans un dossier cbservers a cote de l'executable au lieu d'AppData. Equivalent de l'option -portable. Le changement deplace vos donnees vers le nouvel emplacement et redemarre le launcher.",
                ...
                portableConfirmBody: 'Vos parametres, clients et recus de mods seront deplaces vers le nouvel emplacement et le launcher redemarrera. Les caches seront reconstruits a la premiere utilisation. Continuer ?',
                portableFailed: "Impossible de deplacer les donnees du launcher. Rien n'a ete modifie.",
                offlineMode: 'Mode hors ligne',
                offlineModeBody: "Lorsqu'active, le launcher demarre sans mises a jour, Discord ni CB Friends. Equivalent de l'option -offline. Prend effet au prochain demarrage du launcher.",
                autoShortcuts: 'Creer les raccourcis du launcher',
                autoShortcutsBody: 'Conserve un raccourci sur le Bureau et dans le menu Demarrer. Le desactiver coupe aussi les notifications Windows, car elles passent par le raccourci du menu Demarrer.',
                ...
                cliLaunch: "Lancer un jeu au demarrage (cod4, waw, mw2, bo1, mw3, bo2, cod2 ou tout id de la bibliotheque)",
                cliMode: "Mode a utiliser avec -launch",
                cliInstall: "Ouvrir l'installation d'un jeu au demarrage",
                cliNoUpdate: "Ignorer la mise a jour automatique du launcher",
                cliOffline: "Demarrer sans fonctions reseau (pas de mises a jour, Discord ni social)",
                ...
                maintenance: 'Maintenance',
                theme: 'Theme',
                themeTactical: 'Tactique Black Ops',
                themeTacticalMw: 'Tactique Modern Warfare',
                themeNavy: 'Navy Sombre',
                themeDark: 'Sombre',
                themeNavyGradient: 'Degrade Marine',
                playerCounts: 'Nombre de joueurs',
                playerCountsBody: 'Quel nombre de joueurs en direct la bibliotheque et les pages de jeu affichent. Les joueurs sur les serveurs et ceux dans le launcher sont comptes separement et ne peuvent pas etre additionnes.',
                playerCountsBoth: 'Les deux',
                playerCountsServers: 'Sur les serveurs',
                playerCountsLauncher: 'Dans le launcher',
                playerCountsOff: 'Masque',
            ...
            servers: {
                ...
                join: 'Rejoindre',
                copyConnect: 'Copier',
                copyConnectTitle: 'Copier la commande connect, puis la coller dans la console du jeu',
                connectCopied: '"{{command}}" copie. Collez-le dans la console du jeu.',
            ...
            game: {
                ...
                'h1-mod': {
                    ...
                    descriptionWarning: "Si vous avez une carte graphique NVIDIA RTX, laissez l'option Pre-Cache Shaders desactivee dans le jeu. L'activer fait planter le jeu sur les GPU RTX.",
                ...
                'hmw-mod': {
                    description: "HorizonMW est un remaster communautaire du multijoueur de Modern Warfare 2, avec des cartes, des armes et des systemes de MWR et MW3 ainsi que quelques armes de Ghosts.",
                    descriptionWarning: "Si vous avez une carte graphique NVIDIA RTX, laissez l'option Pre-Cache Shaders desactivee dans le jeu. L'activer fait planter le jeu sur les GPU RTX.",
        ...
        es: {
            ...
            friends: {
                ...
                openMatch: 'Privada',
                more: 'Más',
                emptyCb: 'Todavia no tienes amigos. Agrega a alguien por su nombre de usuario.',
                setupTitle: 'Juega con amigos',
                setupBody: 'Crea un perfil CB para agregar amigos por su nombre de usuario y enviarles mensajes, personalizar tu perfil y registrar tu tiempo de juego en cada juego. O vincula Discord para ver a tus amigos de Discord que usan el launcher.',
                setupCbBody: 'Crea un perfil CB para agregar amigos por su nombre de usuario y enviarles mensajes, personalizar tu perfil, registrar tu tiempo de juego en cada juego y jugar con quienes no usan Discord.',
                createCb: 'Crear perfil CB',
                linkDiscord: 'Vincular Discord',
                unlinkDiscord: 'Desvincular Discord',
                discordLinked: 'Discord vinculado',
                discordFriend: 'Amigo de Discord',
            ...
            toasts: {
                ...
                friendOffline: 'Ese amigo no esta en el launcher ahora mismo',
            ...
            common: {
                ok: 'OK',
                cancel: 'Cancelar',
                inServers: 'en servidores',
                inLauncher: 'en el launcher',
                inServersHint: 'Jugadores en servidores publicos ahora mismo',
                inLauncherHint: 'Personas jugando a este juego desde el launcher CB ahora mismo',
                confirm: 'Confirmar',
                save: 'Guardar',
                play: 'Jugar',
            ...
            settings: {
                ...
                skipSelfUpdate: 'Omitir actualizacion del launcher al iniciar',
                skipSelfUpdateBody: 'Cuando esta activado, el launcher no se actualizara al iniciar. Equivale a la opcion -noupdate. Se aplica la proxima vez que se inicie el launcher.',
                restartOffline: 'Reiniciar sin conexion',
                restartOnline: 'Reiniciar en linea',
                portableMode: 'Modo portatil',
                portableModeBody: 'Guarda los datos y ajustes del launcher en una carpeta cbservers junto al ejecutable en lugar de AppData. Equivale a la opcion -portable. Al cambiar se mueven tus datos a la nueva ubicacion y el launcher se reinicia.',
                ...
                portableConfirmBody: 'Tus ajustes, clientes y recibos de mods se moveran a la nueva ubicacion y el launcher se reiniciara. Las caches se reconstruyen al primer uso. Continuar?',
                portableFailed: 'No se pudieron mover los datos del launcher. No se cambio nada.',
                offlineMode: 'Modo sin conexion',
                offlineModeBody: 'Cuando esta activado, el launcher se inicia sin actualizaciones, Discord ni CB Friends. Equivale a la opcion -offline. Se aplica la proxima vez que se inicie el launcher.',
                autoShortcuts: 'Crear accesos directos del launcher',
                autoShortcutsBody: 'Mantiene un acceso directo en el Escritorio y en el menu Inicio. Desactivarlo tambien detiene las notificaciones de Windows, ya que se entregan a traves del acceso directo del menu Inicio.',
                ...
                cliLaunch: "Iniciar un juego al arrancar (cod4, waw, mw2, bo1, mw3, bo2, cod2 o cualquier id de la biblioteca)",
                cliMode: "Modo a usar junto con -launch",
                cliInstall: "Abrir la instalacion de un juego al arrancar",
                cliNoUpdate: "Omitir la actualizacion automatica del launcher",
                cliOffline: "Iniciar sin funciones de red (sin actualizaciones, Discord ni social)",
                ...
                theme: 'Tema',
                themeTactical: 'Táctico Black Ops',
                themeTacticalMw: 'Táctico Modern Warfare',
                themeNavy: 'Navy oscuro',
                themeDark: 'Oscuro',
                themeNavyGradient: 'Degradado Navy',
                playerCounts: 'Jugadores en linea',
                playerCountsBody: 'Que recuento de jugadores en vivo muestran la biblioteca y las paginas de juego. Los jugadores en servidores y los jugadores en el launcher se cuentan por separado y no se pueden sumar.',
                playerCountsBoth: 'Ambos',
                playerCountsServers: 'En servidores',
                playerCountsLauncher: 'En el launcher',
                playerCountsOff: 'Oculto',
            ...
            servers: {
                ...
                join: 'Unirse',
                copyConnect: 'Copiar',
                copyConnectTitle: 'Copia el comando connect y pegalo en la consola del juego',
                connectCopied: '"{{command}}" copiado. Pegalo en la consola del juego.',
            ...
            game: {
                ...
                'h1-mod': {
                    ...
                    descriptionWarning: "Si tienes una tarjeta grafica NVIDIA RTX, manten desactivada la opcion Pre-Cache Shaders del juego. Activarla hace que el juego se cierre en GPUs RTX.",
                ...
                'hmw-mod': {
                    description: "HorizonMW es una remasterizacion comunitaria del multijugador de Modern Warfare 2, con mapas, armas y sistemas de MWR y MW3 junto con algunas armas de Ghosts.",
                    descriptionWarning: "Si tienes una tarjeta grafica NVIDIA RTX, manten desactivada la opcion Pre-Cache Shaders del juego. Activarla hace que el juego se cierre en GPUs RTX.",
        ...
        ru: {
            ...
            friends: {
                ...
                openMatch: 'Приватная',
                more: 'Ещё',
                emptyCb: 'Пока нет друзей. Добавьте кого-нибудь по имени пользователя.',
                setupTitle: 'Играйте с друзьями',
                setupBody: 'Создайте профиль CB, чтобы добавлять друзей по имени пользователя и переписываться с ними, настраивать свой профиль и отслеживать время в каждой игре. Или привяжите Discord, чтобы видеть друзей из Discord, которые пользуются лаунчером.',
                setupCbBody: 'Создайте профиль CB, чтобы добавлять друзей по имени пользователя и переписываться с ними, настраивать свой профиль, отслеживать время в каждой игре и играть с теми, кого нет в Discord.',
                createCb: 'Создать профиль CB',
                linkDiscord: 'Привязать Discord',
                unlinkDiscord: 'Отвязать Discord',
                discordLinked: 'Discord привязан',
                discordFriend: 'Друг в Discord',
            ...
            toasts: {
                ...
                friendOffline: 'Этот друг сейчас не в лаунчере',
            ...
            common: {
                ok: 'ОК',
                cancel: 'Отмена',
                inServers: 'на серверах',
                inLauncher: 'в лаунчере',
                inServersHint: 'Игроки на публичных серверах прямо сейчас',
                inLauncherHint: 'Люди, запустившие эту игру из лаунчера CB прямо сейчас',
                confirm: 'Подтвердить',
                save: 'Сохранить',
                play: 'Играть',
            ...
            settings: {
                ...
                skipSelfUpdate: 'Пропускать обновление лаунчера при запуске',
                skipSelfUpdateBody: 'При включении лаунчер не будет обновляться при запуске. То же, что флаг -noupdate. Вступает в силу при следующем запуске лаунчера.',
                restartOffline: 'Перезапустить автономно',
                restartOnline: 'Перезапустить онлайн',
                portableMode: 'Портативный режим',
                portableModeBody: 'Хранит данные и настройки лаунчера в папке cbservers рядом с exe вместо AppData. То же, что флаг -portable. При переключении данные переносятся в новое место и лаунчер перезапускается.',
                ...
                portableConfirmBody: 'Настройки, клиенты и данные модов будут перенесены в новое место, и лаунчер перезапустится. Кэши создадутся заново при первом использовании. Продолжить?',
                portableFailed: 'Не удалось перенести данные лаунчера. Ничего не изменено.',
                offlineMode: 'Автономный режим',
                offlineModeBody: 'При включении лаунчер запускается без обновлений, Discord и CB Friends. То же, что флаг -offline. Вступает в силу при следующем запуске лаунчера.',
                autoShortcuts: 'Создавать ярлыки лаунчера',
                autoShortcutsBody: 'Поддерживает ярлык на рабочем столе и в меню Пуск. Отключение также отключает уведомления Windows, так как они доставляются через ярлык в меню Пуск.',
                ...
                cliLaunch: "Запустить игру при старте (cod4, waw, mw2, bo1, mw3, bo2, cod2 или любой id из библиотеки)",
                cliMode: "Режим для использования вместе с -launch",
                cliInstall: "Открыть установку игры при старте",
                cliNoUpdate: "Пропустить проверку обновления лаунчера",
                cliOffline: "Запуск без сетевых функций (без обновлений, Discord и социальных функций)",
                ...
                theme: 'Тема',
                themeTactical: 'Тактическая Black Ops',
                themeTacticalMw: 'Тактическая Modern Warfare',
                themeNavy: 'Тёмно-синяя',
                themeDark: 'Тёмная',
                themeNavyGradient: 'Градиент тёмно-синий',
                playerCounts: 'Счётчик игроков',
                playerCountsBody: 'Какой счётчик игроков показывать в библиотеке и на страницах игр. Игроки на серверах и игроки в лаунчере считаются отдельно и не суммируются.',
                playerCountsBoth: 'Оба',
                playerCountsServers: 'На серверах',
                playerCountsLauncher: 'В лаунчере',
                playerCountsOff: 'Скрыть',
            ...
            servers: {
                ...
                join: 'Войти',
                copyConnect: 'Копировать',
                copyConnectTitle: 'Скопируйте команду connect и вставьте её в игровую консоль',
                connectCopied: 'Скопировано: "{{command}}". Вставьте в игровую консоль.',
            ...
            game: {
                ...
                'h1-mod': {
                    ...
                    descriptionWarning: "Если у вас видеокарта NVIDIA RTX, оставьте настройку Pre-Cache Shaders в игре выключенной. Её включение приводит к вылетам игры на RTX.",
                ...
                'hmw-mod': {
                    description: 'HorizonMW, это ремастер мультиплеера Modern Warfare 2 от сообщества с картами, оружием и системами из MWR и MW3, а также несколькими видами оружия из Ghosts.',
                    descriptionWarning: "Если у вас видеокарта NVIDIA RTX, оставьте настройку Pre-Cache Shaders в игре выключенной. Её включение приводит к вылетам игры на RTX.",
