    ...
    const translations = {
        en: {
            ...
            mods: {
                ...
                steamNotOwned: 'Workshop downloads require owning {{game}} on Steam. You can still import maps and mods manually.',
                steamSignIn: 'Sign in to Steam to download Workshop items through the launcher.',
                steamSignInAction: 'Sign in to Steam',
                locked: 'Requires Steam',
        ...
        fr: {
            ...
            mods: {
                ...
                steamNotOwned: 'Les telechargements Workshop necessitent de posseder {{game}} sur Steam. Vous pouvez toujours importer des cartes et mods manuellement.',
                steamSignIn: 'Connectez-vous a Steam pour telecharger des elements du Workshop via le launcher.',
                steamSignInAction: 'Se connecter a Steam',
                locked: 'Steam requis',
        ...
        es: {
            ...
            mods: {
                ...
                steamNotOwned: 'Las descargas del Workshop requieren tener {{game}} en Steam. Aun puedes importar mapas y mods manualmente.',
                steamSignIn: 'Inicia sesion en Steam para descargar elementos del Workshop desde el launcher.',
                steamSignInAction: 'Iniciar sesion en Steam',
                locked: 'Requiere Steam',
        ...
        ru: {
            ...
            mods: {
                ...
                sourceImport: 'Импорт',
                steamNotOwned: 'Для загрузки из Мастерской нужно владеть {{game}} в Steam. Карты и моды по-прежнему можно импортировать вручную.',
                steamSignIn: 'Войдите в Steam, чтобы загружать контент Мастерской через лаунчер.',
                steamSignInAction: 'Войти в Steam',
                locked: 'Нужен Steam',
