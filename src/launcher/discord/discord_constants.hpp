...
namespace discord
{
    ...
    // Self-hosted invite relay, now served by the cbfriends worker rather than its own service.
    // Carries invites and join requests off Discord's app-wide rate-limited surface.
    // Override with -relay-url <url>.
